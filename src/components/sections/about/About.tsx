        ...
        <section id="about">
            <div className="about-container">
                ...
                <div className="about-right">
                    <h1>About me</h1>
                    <p>Hi, I’m David, a junior web developer with a focus on crafting robust, functional, and visually striking websites that bring ideas to life. I specialize in building user-friendly applications using modern tools like <span className="highlighted">React</span>, <span className="highlighted">TypeScript</span>, and <span className="highlighted">.NET Core</span>.</p>
